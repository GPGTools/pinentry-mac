/* PinentryController.m - PIN entry dialogue for Mac OS.
   ...
   Revised 2008 by Benjamin Donnachie <benjamin@py-soft.co.uk>   
     InstructionBox changed to NSTextView.
...
//		 [plainPINField setSelectedRange: NSMakeRange([[plainPINField stringValue] length], 0)];
		}
}
